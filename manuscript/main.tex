...
\small
\resizebox{0.92\textwidth}{!}{\input{../tables/table_market_descriptives.tex}}
...
\small
\resizebox{0.94\textwidth}{!}{\input{../tables/table_main_results.tex}}
...
\small
\resizebox{0.96\textwidth}{!}{\input{../tables/table_mechanism_comparison.tex}}
\begin{minipage}{0.97\textwidth}\footnotesize
...
\small
\resizebox{0.96\textwidth}{!}{\input{../tables/table_historical_replay.tex}}
\begin{minipage}{0.97\textwidth}\footnotesize
...
\scriptsize
\resizebox{0.98\textwidth}{!}{\input{../tables/table_robustness.tex}}
...
\textbf{Niko Rokni Lamouki:} Conceptualization, methodology, software, formal analysis, data curation, visualization, writing--original draft, and project administration. \textbf{Salma Soofiyan:} Conceptualization, validation, interpretation, and writing--review and editing. Both authors approved the final manuscript.
...
\textbf{Consent for publication.} Both authors consent to publication.\\
